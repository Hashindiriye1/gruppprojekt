...
public class CustomersController(CustomerService service, IValidator<CreateCustomerDto> createValidator, IValidator<UpdateCustomerDto> updateValidator) : ControllerBase
{
    [HttpGet]
